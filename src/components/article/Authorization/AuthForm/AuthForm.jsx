            ...
            <div className={Styles.authWrapper}>
                ...
                <div className={Styles.authSubWrapper}>
                    <div className={Styles.inputWrap}>
                        <Field validate={[requiredField, maxLength32, minLength4]} name={'email'} component={ValidateInput}
                               className={cn(Styles.input, Styles.required)} type="email" placeholder={'Email'}/>
                    </div>
                    <div className={Styles.inputWrap}>
                        <Field validate={[requiredField, maxLength32, minLength4]} name={'password'} component={ValidateInput}
                               className={cn(Styles.input, Styles.required)} type="password" placeholder={'Password'}/>
                    </div>
                ...
                {props.captchaUrl ?
                    <div className={Styles.captchaUrl}>
                        <div>
                            <img className={Styles.captchaUrlImage} src={props.captchaUrl} alt=""/>
                        </div>
                        <Field name={'captcha'} component={CaptchaInput}
                               className={Styles.captchaInp} type="textarea" placeholder={'Type the characters'}/>
                    </div>
                    : false }
